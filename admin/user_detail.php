...
$custom_css = '<link rel="stylesheet" href="/FD-Tech/assets/css/style_user_management.css">';
            ...
            <div class="user-detail-card">
                ...
                <div class="user-detail-grid">
                    ...
                    <div class="detail-item">
                        ...
                        <strong><?= htmlspecialchars($user['phone'] ?? 'Chưa cập nhật') ?></strong>
                    </div>
                    <div class="detail-item">
                        <span>Giới tính</span>
                        <strong>
                    ...
                    <div class="detail-item full-width">
                        <span>Địa chỉ</span>
                        <strong><?= htmlspecialchars($user['address'] ?? 'Chưa cập nhật') ?></strong>
                    </div>
                    <div class="detail-item">
                ...
                <div class="detail-actions">
                    ...
                    <form 
                        method="POST" 
                        action="action_user/update_user_status.php"
