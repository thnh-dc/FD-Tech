    ...
    <div class="admin-wrapper" style="padding: 40px; background: var(--bg-light); min-height: 100vh;">
        <div style="max-width: 1000px; margin: 0 auto;">
            ...
            <header style="margin-bottom: 30px;">
                <a href="list_product.php" style="text-decoration: none; color: var(--text-muted); font-size: 14px;">← Quay lại danh sách</a>
                <h1 style="margin-top: 10px; color: var(--primary);">Cập nhật: [Tên Sản Phẩm Cũ]</h1>
            </header>
