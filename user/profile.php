...
$current_tier_icon = getFDMemberIcon($current_tier['tier_key']);
...
$allowed_actions = ['account', 'password', 'orders', 'notifications', 'history_bought', 'membership'];
...
<link rel="stylesheet" href="../assets/css/style_membership.css">
        ...
        <div class="profile-sidebar">
            <div class="user-brief">
                ...
                <div>
                    ...
                    <a href="?action=membership" class="member-rank-link">
                        <i class="fas <?= htmlspecialchars($current_tier_icon) ?>"></i>
                        Thành viên <?= htmlspecialchars($current_tier['tier_name']) ?>
                    </a>
                </div>
            </div>
            <ul class="profile-menu">
                <li>
                    <a href="?action=account" class="menu-link <?php echo $action == 'account' ? 'active' : ''; ?>">
                        <i class="far fa-user"></i> Tài khoản của tôi
                    </a>
                </li>

                <li>
                    <a href="?action=password" class="menu-link <?php echo $action == 'password' ? 'active' : ''; ?>">
                        <i class="fas fa-lock"></i> Đổi mật khẩu
                    </a>
                </li>

                <li>
                    <a href="?action=orders" class="menu-link <?php echo $action == 'orders' ? 'active' : ''; ?>">
                        <i class="fas fa-clipboard-list"></i> Đơn mua
                    </a>
                </li>

                <li>
                    <a href="?action=notifications" class="menu-link <?php echo $action == 'notifications' ? 'active' : ''; ?>">
                        <i class="fas fa-bell"></i> Thông báo
                    </a>
                </li>

                <li>
                    <a href="?action=history_bought" class="menu-link <?php echo $action == 'history_bought' ? 'active' : ''; ?>">
                        <i class="fas fa-chart-bar"></i> Thống kê
                    </a>
                </li>

                <li>
                    <a href="?action=membership" class="menu-link <?php echo $action == 'membership' ? 'active' : ''; ?>">
                        <i class="fas <?= htmlspecialchars($current_tier_icon) ?>"> </i> FD Member
                    </a>
                </li>

                <li style="margin-top: 20px; border-top: 1px solid #eee; padding-top: 10px;">
                    <a href="../auth/logout.php" style="color: #DB4437;">
    ...
    function previewImage(event) {
        ...
        reader.onload = function () {
            ...
            if (document.getElementById('sidebar-avatar')) {
                document.getElementById('sidebar-avatar').src = reader.result;
            }
        };
